...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng sydney = new LatLng(10.803625, 106.638352);
        mMap.addMarker(new MarkerOptions().position(sydney).title("Location Place"));
        ...
        try{
            requestUrl = "https://maps.googleapis.com/maps/api/directions/json?" +
                    ...
                    "origin=" + destination +"&"+
                    "&destination=" + sydney.latitude + "," + sydney.longitude + "&" +
                    ...
                    .enqueue(new Callback<String>() {
                        ...
                        public void onResponse(Call<String> call, Response<String> response) {
                            try{
                                ...
                                .flat(true)
                                .icon(BitmapDescriptorFactory.fromResource(R.drawable.oto)));
